...
function itemFormSubmit() {
    const formObj = {};
    const itemID = generateUniqueID('I');
    ...
    formObj.name = itemName;
    formObj.status = itemRadio;
    formObj.price = itemPrice;
...
saveitemDOM.addEventListener('click', ()=>{
    ...
    if(formString) {
        ...
        axios.post('http://localhost:8080/deo-api/public/item', formObj)
                        ...
                        <table class="table table-sm">
                            <thead class="text-warning">
                                ...
                                <tr>
                                    ...
                                    <th scope="col">${formObj.status}</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
